...
- Pack compatibility contract spec: [theme-pack-spec-v1.md](C:/python/old/restart/docs/reference/theme-pack-spec-v1.md)
- Content/mod publishing guidance: [content-authoring-and-mod-publishing-guidelines.md](C:/python/old/restart/docs/reference/content-authoring-and-mod-publishing-guidelines.md)
