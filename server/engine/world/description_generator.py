...
def generate_room_description(world: 'World', minimal: bool = False, player=None) -> str:
    ...
    # A room may declare a local climate for authored extremes. Otherwise its
    # region's content-owned climate profile interprets the ambient weather.
    weather = world.game.weather_manager.effective_weather(current_region, current_room)
