...
func update_db_lists(npcs: Dictionary, items: Dictionary, templates: Dictionary, magic: Dictionary, quests: Dictionary, recipes: Dictionary, dialogues: Dictionary, titles: Dictionary, dirty_flags: Dictionary):
	side_panel.update_db_lists(npcs, items, templates, magic, quests, dirty_flags)
	content_library.update_data(npcs, items, templates, magic, quests, recipes, dialogues, titles, dirty_flags)
